...
image:
  placement: 1
  caption: 'UMAP representation of market vegatable oils'
  focal_point: Center
  preview_only: no
output:
  blogdown::html_page:
...
links:
  - icon: 
    icon_pack: fab
    name: Data from the model data pacakge 
...
umap_juiced %>%
  ...
  labs(color = NULL)
```
![UMAP representation of market vegatable oils](/Users/dermit01/Documents/mariadermit/content/post/2021-02-04-PCA_UMAP_tidymodels/featured.jpg)
