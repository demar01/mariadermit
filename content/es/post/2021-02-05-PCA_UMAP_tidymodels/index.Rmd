---
title: PCA and UMAP clasificación de aceites vegetales con tidymodels & base R 
author: maria
date: '2021-02-04'
categories:
  - R
...
links:
  - icon: 
    icon_pack: fab
    name: Datos del pauqete modeldata  
...
pca_res
```
Podemos ver que los componentes de PC para cada clase de aceite se agregaron en un objeto `prcomp`.
