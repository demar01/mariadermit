...
links:
  - icon: 
    icon_pack: fab
    name: Para saber más sobre metaprogramación (en)
...
`r emo::ji("information")` Este post te puede resultar beneficioso si has leído los [capítulos 17-20 del libro de Advanced R](https://adv-r.hadley.nz/metaprogramming.html) y estás buscando encontrar más ejemplos adicionales y en es al gran recurso de [Mara] (https://maraaverick.rbind.io/2017/08/tidyeval-resource-roundup/).
