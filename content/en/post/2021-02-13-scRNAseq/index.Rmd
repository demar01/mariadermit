...
image:
  placement: 1
  caption: '[Un dimanche après-midi à lÎle de la Grande Jatte](https://en.wikipedia.org/wiki/A_Sunday_Afternoon_on_the_Island_of_La_Grande_Jatte)'
  focal_point: Center
  preview_only: no
output:
  blogdown::html_page:
...
Dr. Eric Chow gives a fantastic overview of Droseq ([min 7:08](https://www.youtube.com/watch?v=k9VFNLLQP8c&t=1083s)).\
\
